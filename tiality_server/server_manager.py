...
class TialityServerManager:
    ...
    def start_servers(self):
        ...
        self._connection_manager_thread = threading.Thread(target=_connection_manager_worker, args=(self.video_queue, self.command_queue, self.connection_established_event, self.shutdown_event))
